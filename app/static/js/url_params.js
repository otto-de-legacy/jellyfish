...
o_p13n.tools.url_params = function () {
    ...
    var manageJobFilter = function () {
        $('#job_filter_switch').click(function () {
                setUrlParameter("jobs", $(this).data("filtered"), true);
            }
        );
    };

    var manageStatusAgeFilter = function () {
        $('#show_age_filter_switch').click(function () {
                setUrlParameter("status_age", $(this).data("filtered"), true);
            }
        );
    };

    var manageActiveColorOnlyFilter = function () {
        $('#active_color_only_filter_switch').click(function () {
                setUrlParameter("active_color_only", $(this).data("filtered"), true);
            }
        );
    };

    var manageLevelFilter = function () {
        $('.js_level_filter').each(function () {
            var $this = $(this);
            $this.click(function () {
                setUrlParameter("level", $(this).data("level"), true);
            });
        });
    };
    ...
    module.init = function () {
        ...
        changeUrlOnTabClick();
        manageJobFilter();
        manageStatusAgeFilter();
        manageActiveColorOnlyFilter();
        manageLevelFilter();
    };
