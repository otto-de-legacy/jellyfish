...
class TestView(unittest.TestCase):
    ...
    @mock.patch('app.update.get_beanstalk_environments',
                return_value={'mammal-dog': 'mammal-dog-develop',
                              'mammal-cat': 'mammal-cat-develop'})
    @mock.patch('app.update.get_beanstalk_health', return_value={'info': 'data'})
    def test_update_aws(self, *_):
        service = {'id': '/dog-ci/vertical', 'access_key': 'AAAA', 'secret_key': '1234'}

        update.update_aws('1234', service, 0, greedy=True)
